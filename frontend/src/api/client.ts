...
export const api = {
  ...
  appointOrchestrator: (id: number, role_id: number | null, expected_revision: number) => request<Conversation>(`/api/conversations/${id}/orchestrator`, { method: 'PUT', body: JSON.stringify({ role_id, expected_revision }) }),
